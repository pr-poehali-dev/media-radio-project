...
const interviews = [
  {
    ...
    litnetLinks: [
      ...
      { title: '«Зеркало для нарцисса»', url: 'https://litnet.com/ru/reader/zerkalo-dlya-narcissa-b553819' }
    ],
    images: [
...
Не останавливаясь на достигнутом, Таисия взялась за новый, ещё более сложный жанр. Сейчас она активно работает над психологическим триллером «Зеркало для нарцисса». Книга исследует темные стороны человеческой натуры, манипуляции и абьюз. Пока роман не завершён, но первые главы уже можно прочитать также на Литнет.
