...
const interviews = [
  {
    ...
    date: '2 ноября 2025',
    excerpt: 'Русскоязычная писательница Таисия Кайсарова о любви, женской измене и новом психологическом триллере. Знакомство с автором, который только начинает свой путь в большой литературе.',
...
<img src="https://cdn.poehali.dev/files/95435fce-8297-4338-aaca-6c65782fe977.jpg" alt="Таисия Кайсарова" class="interview-photo" />
...
Книга мгновенно нашла отклик у читательниц, которые узнали в героях себя и свои истории. Роман уже завершён и доступен для чтения на популярной литературной платформе <a href="https://litnet.com/ru/book/razbitaya-v-seti-b533504" target="_blank" rel="noopener noreferrer" class="interview-link">Литнет</a>.

🔪 «ЗЕРКАЛО ДЛЯ НАРЦИССА» — НОВЫЙ ВЫЗОВ

Не останавливаясь на достигнутом, Таисия взялась за новый, ещё более сложный жанр. Сейчас она активно работает над психологическим триллером «Зеркало для нарцисса». Книга исследует темные стороны человеческой натуры, манипуляции и абьюз. Пока роман не завершён, но первые главы уже можно прочитать также на <a href="https://litnet.com/ru/reader/zerkalo-dlya-narcissa-b553819" target="_blank" rel="noopener noreferrer" class="interview-link">Литнет</a>.
...
📖 Следить за творчеством Таисии и читать её книги можно на её странице на Литнет:
• <a href="https://litnet.com/ru/book/razbitaya-v-seti-b533504" target="_blank" rel="noopener noreferrer" class="interview-link">«Разбитая в сети»</a>
• <a href="https://litnet.com/ru/reader/zerkalo-dlya-narcissa-b553819" target="_blank" rel="noopener noreferrer" class="interview-link">«Зеркало для нарцисса»</a>`
  },
  {
    id: 1,
