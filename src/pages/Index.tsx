              ...
              <CardContent className="p-0 relative">
                <div className="relative w-full bg-black" style={{ paddingBottom: '56.25%' }}>
                  <div className="absolute top-0 left-0 z-20">
                    <div className="bg-black/95 border-2 border-primary/50 rounded-br-2xl px-6 py-5 backdrop-blur-md">
                      <h3 className="text-white font-bold text-2xl whitespace-nowrap leading-tight">
                  ...
                  <div className="absolute top-0 right-0 z-20">
                    <div className="bg-black/95 border-2 border-primary/50 rounded-bl-2xl px-6 py-5 backdrop-blur-md">
                      <div className="text-white font-mono text-2xl font-bold tracking-wider leading-tight">
                        {currentTime.toLocaleTimeString('ru-RU', { 
                          timeZone: 'Europe/Moscow',
                          hour: '2-digit', 
                          minute: '2-digit' 
                        })}
                        <span className="text-primary/80 text-base ml-1.5">МСК</span>
                      </div>
                    </div>
                  </div>
