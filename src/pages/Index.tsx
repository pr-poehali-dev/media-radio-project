...
💌 Присоединяйтесь к сообществу Кати ВКонтакте и следите за новыми релизами!`
  },
  {
    ...
    publishedAt: new Date('2026-11-02T00:00:00'),
    initialViews: 101,
    viewsPerHour: 1.5,
    litnetLinks: [
...
В июне 2026 года Таисия села за написание своего первого романа. Им стала история «Разбитая в сети» — актуальное и психологически точное повествование о том, к чему может привести обычная переписка в социальных сетях.
...
Таисия Кайсарова — автор, который только начинает свой большой путь в большой литературе, но уже сейчас ясно, что её голос будет звучать громко и точно найдёт отклик в сердцах многих.`
  },
  {
    ...
    publishedAt: new Date('2026-11-01T00:00:00'),
    initialViews: 4509,
    viewsPerHour: 0.006,
    images: [
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    const text = 'КонтентМедиаPRO — журнал №1 2026';
                    if (navigator.share) {
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      const text = 'КонтентМедиаPRO — журнал №2 Апрель 2026';
                      if (navigator.share) {
                        navigator.share({ title: text, url });
                      } else {
                        navigator.clipboard.writeText(url);
                        ...
                        <div className="flex flex-col gap-0" style={{ width: '30%' }}>
                          ...
                          <div className="relative overflow-hidden border-b border-red-900/50 flex-1" style={{ minHeight: '44vh' }}>
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-1.5">
                              ...
                              <p className="text-white text-[8px] leading-tight mt-0.5">«Старый знакомый» — не единственный. Игра? Новый трек.</p>
                ...
                <div className="flex-none w-full snap-start">
                  <div className="relative w-full overflow-hidden rounded-xl flex flex-col" style={{ background: '#0f0f0f', minHeight: '92vh' }}>
                    ...
                    <div className="flex-1 px-3 pt-1 pb-10 overflow-y-auto">
                      {([
                        { n: 1,  accent: false, title: 'Катя Денисова',           sub: '«Старый знакомый» — не единственный. Игра? Новый трек.' },
                  ...
                  <div className="relative w-full overflow-hidden rounded-xl" style={{ background: '#0f0f0f', minHeight: '92vh' }}>
                    ...
                    <div className="px-3 pt-3 pb-16 space-y-3">
                      ...
                      <div className="flex gap-3 items-start">
                        ...
                        <div className="flex-1">
                          <h3 className="text-white font-black text-[13px] leading-tight mb-1.5">«Старый знакомый» — не единственный. Игра? Новый трек.</h3>
                      ...
                      <div className="flex gap-3 items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-[10px] leading-relaxed mt-1.5">Она была его целью, но... Поезд уже ушёл. Он уже видел её трофеем, себя — охотником. Только она не играла в его игру: не читала сценарий, не ждала на перроне. У неё своя игра: это его сегодня сделали трофеем.</p>
                        </div>
                        <div className="flex-none" style={{ width: '36%' }}>
                          <div className="relative rounded-xl overflow-hidden shadow-lg" style={{ height: '155px' }}>
                            <img
                ...
                <div id="apr-page-11" className="flex-none w-full snap-start">
                  <div className="relative w-full overflow-hidden rounded-xl" style={{ background: '#0a0a14', minHeight: '92vh' }}>
                    ...
                    <div className="px-3 pt-3 pb-16 space-y-2.5">
                      ...
                      {/* Советы */}
                      {[
                        { n: '01', icon: '🎸', hero: 'Катя Денисова', title: 'Жизнь — лучший сценарий', text: 'Старый знакомый, игра, история — Катя увидела в этом сюжет и превратила в трек. Твой опыт уже готовый материал.' },
                  ...
                  <div className="relative w-full overflow-hidden rounded-xl" style={{ background: '#08080f', minHeight: '92vh' }}>
                    ...
                    <div className="px-4 pt-5 pb-16 flex flex-col items-center space-y-4">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-red-400 text-[9px] tracking-widest uppercase mt-0.5">Апрельский выпуск · 2026</p>
                      </div>
