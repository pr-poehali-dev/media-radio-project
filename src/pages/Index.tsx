...
const defaultInterviews = [
  {
    id: 6,
    artist: 'Алексей Лебедев (группа СПЛАВ)',
...
Сегодня мы беседуем с Алексеем Лебедевым, лидером группы СПЛАВ, о новом EP «Преодоление. Трилогия» — трёх треках, которые ведут слушателя через три стадии внутренней трансформации.
...
<img src="https://cdn.poehali.dev/files/67cc76b2-f359-4fd6-825d-e208574a7a79.jpg" alt="Обложка EP СПЛАВ" class="interview-photo" />
...
💫 Не отпускайте настроение. Подпишитесь на сообщество группы СПЛАВ ВКонтакте, чтобы всегда оставаться на связи с музыкой, которая говорит о главном.`
  },
  {
    id: 5,
