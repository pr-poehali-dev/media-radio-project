...
const defaultInterviews = [
  {
    id: 8,
    artist: 'Начинающий музыкант',
    title: 'Музыка, как откровение: откровенный разговор с артистом',
    date: '29 ноября 2025',
    ...
    fullText: `🎵 МУЗЫКА, КАК ОТКРОВЕНИЕ: ОТКРОВЕННЫЙ РАЗГОВОР С АРТИСТОМ

Сегодня у нас в гостях музыкант, чьи песни находят отклик в сердцах многих. В этом интервью мы попытались заглянуть за кулисы творческого процесса и узнать, что же на самом деле движет автором таких проникновенных треков.
