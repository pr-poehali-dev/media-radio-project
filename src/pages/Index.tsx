                    ...
                    <div className="px-3 pt-3 pb-16 space-y-3">
                      ...
                      <div className="flex gap-3 items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-400 text-[10px] leading-relaxed mt-1.5">Он хотел её — но перрон уже опустел. Поезд ушёл, а билет так и остался в кармане. <span className="text-red-400 font-semibold">Зато стал хитом.</span></p>
                        </div>
                        <div className="flex-none" style={{ width: '36%' }}>
                          <div className="relative rounded-xl overflow-hidden shadow-lg" style={{ height: '155px' }}>
                            <img
